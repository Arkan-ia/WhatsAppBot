...
def save_user_data(
    ...
    try:
        ...
        logging.exception("Error al guardar datos del usuario: %s", str(e))
        raise
...
def get_user_data( number: str) -> Dict:
    ...
    try:
        ...
        logging.exception("Error al obtener datos del usuario: %s", str(e))
        return {}
...
def is_user_info_missing(number: str) -> bool:
    ...
    try:
        ...
        logging.exception("Error al verificar información faltante del usuario: %s", str(e))
        return True